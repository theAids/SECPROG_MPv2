    ...
    <body>
                ...
                <form class="form-horizontal" name="regForm" id = "regForm" method="post" action = "activateAccount" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="col-md-12">
                                <input type="password" required = "true"  pattern=".{6,30}" title="Minimum of 6 characters and maximum of 30." onchange="form.vpassword.pattern = this.value;" placeholder="Old Password" class="form-control" name="password" id="opassword"/>
                            </div>

                            <div class="col-md-12">
                                <input type="password" required = "true"  pattern=".{6,30}" title="Minimum of 6 characters and maximum of 30." onchange="form.vpassword.pattern = this.value;" placeholder="New Password" class="form-control" name="password" id="npassword"/>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#opassword').on('keyup', function(event){
                        var key = String.fromCharCode(event.which);
                        if (!event.shiftKey) {
                            key = key.toLowerCase();
                        }
                        if($(this).val() != "<%= user.getPassword() %>"){
                            submit = 0;
                            $("#opassword").attr('data-original-title', "Invalid Old Password.");
                            $("#opassword").popover({placement: 'right'});
                            $("#opassword").popover("show");
                        }else{
                            $("#opassword").popover("hide");
                            submit = 1;
                        }
