 ...
 */
public class BookManagerBean extends UserBean {

    public BookManagerBean(int userID, String username, String fname, String minitial, String lname, String email, String password, int status) {
