 ...
 */
public class DVDManagerBean extends UserBean{

    public DVDManagerBean(int userID, String username, String fname, String minitial, String lname, String email, String password, int status) {
