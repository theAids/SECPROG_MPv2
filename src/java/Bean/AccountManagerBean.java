 ...
 */
public class AccountManagerBean extends UserBean {

    public AccountManagerBean(int userID, String username, String fname, String minitial, String lname, String email, String password, int status) {
