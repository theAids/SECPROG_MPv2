 ...
 */
public class MagazineManagerBean extends UserBean {

    public MagazineManagerBean(int userID, String username, String fname, String minitial, String lname, String email, String password, int status) {
